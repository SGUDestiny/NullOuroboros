...
public class ElectromagneticAssemblyBlockModel extends EntityModel<Entity> {
    ...
    public final ModelPart emissive1;
    public final ModelPart emissive;
    public final ModelPart emissive2;
    public final ModelPart compass;
    public final ModelPart vane;
    ...
    public ElectromagneticAssemblyBlockModel(ModelPart root) {
        ...
        this.compass = this.bone.getChild("compass");
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(42, 8).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 20.0F, -4.0F));
		...
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -5.0F, 0.0F, 7.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5F, -7.0F, 6.5F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition emissive1 = bone.addOrReplaceChild("emissive1", CubeListBuilder.create().texOffs(0, 41).addBox(-7.0F, -5.0F, -7.0F, 14.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 6.0F, 4.0F));
		...
		PartDefinition compass = bone.addOrReplaceChild("compass", CubeListBuilder.create().texOffs(28, 19).addBox(-4.5F, -1.5F, 0.0F, 9.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.5F, 0.0F));

		PartDefinition compass_r1 = compass.addOrReplaceChild("compass_r1", CubeListBuilder.create().texOffs(28, 22).addBox(-4.5F, -1.5F, 0.0F, 9.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
    ...
    public void renderStaticBody(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay) {
        setAnimatedPartsVisible(false);
        bone.render(poseStack, vertexConsumer, packedLight, packedOverlay);
        setAnimatedPartsVisible(true);
    }

    private void setAnimatedPartsVisible(boolean visible) {
        emissive1.visible = visible;
        emissive.visible = visible;
        emissive2.visible = visible;
        compass.visible = visible;
        vane.visible = visible;
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        renderStaticBody(poseStack, vertexConsumer, packedLight, packedOverlay);
    }
}
