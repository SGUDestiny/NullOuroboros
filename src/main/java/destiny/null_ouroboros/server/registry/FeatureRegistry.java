...
public class FeatureRegistry {
    ...
    public static final RegistryObject<TrunkPlacerType<ScorchedTrunkPlacer>> SCORCHED_TRUNK = TRUNKS.register("scorched_trunk", () -> new TrunkPlacerType<>(ScorchedTrunkPlacer.CODEC));
}
