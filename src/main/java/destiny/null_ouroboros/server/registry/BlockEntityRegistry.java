...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<DeadlockSafeBlockEntity>> DEADLOCK_SAFE_BLOCK_ENTITY = BLOCK_ENTITIES.register("deadlock_safe", () -> BlockEntityType.Builder.of(DeadlockSafeBlockEntity::new, BlockRegistry.DEADLOCK_SAFE.get()).build(null));
    public static final RegistryObject<BlockEntityType<CodelockSafeBlockEntity>> CODELOCK_SAFE_BLOCK_ENTITY = BLOCK_ENTITIES.register("codelock_safe", () -> BlockEntityType.Builder.of(CodelockSafeBlockEntity::new, BlockRegistry.CODELOCK_SAFE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<TerminusTemplateLoaderBlockEntity>> TERMINUS_TEMPLATE_LOADER_BLOCK_ENTITY = BLOCK_ENTITIES.register("terminus_template_loader", () -> BlockEntityType.Builder.of(TerminusTemplateLoaderBlockEntity::new, BlockRegistry.TERMINUS_TEMPLATE_LOADER.get()).build(null));
}